...
from DuruMusic import Carbon, app
...
from DuruMusic.utils.inline.playlist import (
    botplaylist_markup,
...
@app.on_message(
    filters.command(["deleteplaylist", "delplaylist"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & filters.group & ~BANNED_USERS
)
@language
...
@app.on_message(
    filters.command(["deleteplaylist", "delplaylist"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & filters.private & ~BANNED_USERS
)
@language
