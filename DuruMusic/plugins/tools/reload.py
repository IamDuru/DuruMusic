...
from DuruMusic.utils.database import get_authuser_names, get_cmode
from DuruMusic.utils.decorators import ActualAdminCB, AdminActual, language
from DuruMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Duru.stop_stream(message.chat.id)
    except:
        pass
