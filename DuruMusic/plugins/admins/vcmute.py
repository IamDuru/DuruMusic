...
from DuruMusic.utils.database import is_muted, mute_off, mute_on
from DuruMusic.utils.decorators import AdminRightsCheck


@app.on_message(filters.command(["vcmute"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
@AdminRightsCheck
...
@app.on_message(filters.command(["vcunmute"], prefixes=["/", "!", "%", ",", "-", ".", "@", "#"]) & filters.group & ~BANNED_USERS)
@AdminRightsCheck
